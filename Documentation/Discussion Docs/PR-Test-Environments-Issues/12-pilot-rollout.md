...
- [ ] Re-adding `rock:start` redeploys or restarts as expected.
- [ ] `rock:stop` stops the environment while preserving files/site state.
- [ ] `rock:destroy` tears down the environment cleanly.
