<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DynamicGroupRegistration.ascx.cs" Inherits="RockWeb.Plugins.passion.Crm.DynamicGroupRegistration" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                    <h1 class="text-center" runat="server" ID="mainHeader"></h1>
                <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
                    
                    <asp:Panel ID="pnlVisit" runat="server" CssClass="">
                    ...
                    <asp:Panel ID="pnlParents" runat="server" CssClass="">
                        <div class="panel-heading">
                            <hr />
                            <h3 class="text-primary" runat="server" ID="primaryPersonHeader"></h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <%-- <h4>Second Adult</h4> --%>
                            <div class="adult-2-fields hidden">
                    ...
                    <asp:Panel ID="pnlChildren" runat="server" CssClass="">
                        <div class="panel-heading">
                            <hr />
                            <h3 class="text-primary" runat="server" ID="secondaryPersonHeader"></h3>
                        </div>
                        <div class="panel-body">
                            <Passion:PreRegistrationPersons ID="prChildren" runat="server" OnAddChildClick="prChildren_AddChildClick" />
                        </div>
                    </asp:Panel>

                    <div class="actions col-sm-offset-3 col-sm-6 col-xs-12">
                        <br />
                        <asp:LinkButton ID="lbSave" runat="server" Text="Submit" CssClass="btn btn-primary btn-block" OnClick="btnSave_Click" />
                        <asp:LinkButton ID="lbCancel" runat="server" Text="Cancel" CssClass="btn btn-link hidden" CausesValidation="false" />
                        <br />
                    </div>
