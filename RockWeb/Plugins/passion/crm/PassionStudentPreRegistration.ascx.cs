...
using com.passioncitychurch.Model;
...
", CodeEditorMode.Lava, CodeEditorTheme.Rock, 200, true, "", "", 9)]
    ...
    [CustomCheckboxListField("Locations Displayed", "Which locations should be displayed in the dropdown? NOTE: Always keep blank option selected.", "--^--,3F78A057-21B9-4C20-832D-8F1A6F93539D^515,FB8C406E-721C-40BF-A382-7A9FC3236F1D^Cumberland,D4127B24-E6EE-4117-A688-92BB7C23A461^DC", false, null, "", 0, LOCATIONS_DISPLAYED_KEY)]
...
ORDER BY [Text]", false, "", "Child Relationship", 2, "CanCheckinRelationships")]
    ...
    public partial class PassionStudentPreRegistration : RockBlock
    {
        ...
        /// The group members.
        /// </value>
        protected List<PassionPreRegistrationStudent> Children { get; set; }
        ...
        protected override void LoadViewState( object savedState )
        {
            ...
            Children = ViewState["Children"] as List<PassionPreRegistrationStudent> ?? new List<PassionPreRegistrationStudent>();
...
",
        ...
        {
            var row = sender as PassionStudentRow;
        ...
        private void SetControls()
        {
            ...
            {
                if (locationsDisplayed.Length > 2)
                {
        ...
        private void SetCurrentFamilyValues()
        {
            ...
            Children = new List<PassionPreRegistrationStudent>();
            ...
            if ( family != null )
            {
                ...
                {
                    var child = new PassionPreRegistrationStudent( groupMember.Person );
        ...
        private void AddChild()
        {
            ...
            var child = new PassionPreRegistrationStudent( person );
        ...
        private void CreateChildrenControls( bool setSelection )
        {
            ...
            foreach ( var child in Children )
            {
                if ( child != null )
                {
                    var childRow = new PassionStudentRow();
        ...
        private void GetChildrenData()
        {
            ...
            {
                var passionRow = (PassionStudentRow)childRow;
                var person = new Person();
                ...
                child.GradeOffset = 12 - child.AttributeValues["GradeStudents"].AsInteger();
        ...
        private bool ValidateInfo()
        {
            ...
            if (ddlLocation.SelectedValue.IsNullOrWhiteSpace() || ddlLocation.SelectedValue == "--")
            {
