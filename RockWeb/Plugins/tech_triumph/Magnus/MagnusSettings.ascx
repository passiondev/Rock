    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="mt-3">Visual Studio Code Settings</h2>
                        <hr />

                        <asp:Literal ID="lCodeDetailsLeft" runat="server" />

                        <h2 class="mt-3">Azure Data Studio Settings</h2>
                        <hr />

                        <asp:Literal ID="lSqlDetailsLeft" runat="server" />
                    </div>

                    <div class="col-md-6">
                        <h2 class="mt-3">Shared Settings</h2>
                        <hr />
        ...
        <asp:Panel ID="pnlEdit" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="well">
                            <h3>Visual Studio Code Settings</h3>
                            <hr />

                            <Rock:RockDropDownList ID="ddlSecurityRole" runat="server" Label="Security Role" Required="true" CssClass="input-width-xxl mw-100" DataTextField="Name" DataValueField="Id" EnhanceForLongLists="true" Help="The security role a person must belong to to use the plugin." />
                        ...
                        <div class="well">
                            <h3>Azure Data Studio Settings</h3>
                            <hr />

                            <Rock:RockCheckBox ID="cbEnableSql" runat="server" Label="Enable SQL Access" Help="Determines if Azure Data Studio will be allowed to connect to this server and run queries." AutoPostBack="true" OnCheckedChanged="cbEnableSql_CheckedChanged" />

                            <Rock:RockDropDownList ID="ddlSqlSecurityRole" runat="server" Label="SQL Security Role" Required="true" CssClass="input-width-xxl mw-100" DataTextField="Name" DataValueField="Id" EnhanceForLongLists="true" Help="The security role a person must belong to to use the SQL features of the plugin." />
                        </div>
                    </div>
