<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentMethodImport.ascx.cs" Inherits="RockWeb.Plugins.org_mywell.Gateway.PaymentMethodImport" %>
                ...
                <div id="pnlUploadDetails" runat="server">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-4 col-md-8">
                            ...
                            <p style="color: #1a5f70">Welcome to the My Well Gateway tool for importing payment methods. Simply select your existing Financial Gateway, the target Financial Gateway, and upload the import CSV file we provided you.</p>
                            <Rock:FinancialGatewayPicker ID="fgMigratingFromFinancialGateway"  Required="true" runat="server" Label="Previous Financial Gateway" Help="This is the financial gateway you are migrating from. Gateway must be active in order to see it in the list." />
                 ...
                 <!-- Import complete message-->
                    ...
                    <asp:Panel ID="pnlProgress" runat="server" CssClass="panel-body js-messageContainer mt-4" Visible="false">
                        <div class="alert alert-warning shadow-lg mb-0">
                            <asp:Literal ID="ltProgressTitle" Text="<h4>Importing Payment Methods</h4>" runat="server"></asp:Literal>
