...
namespace RockWeb.Blocks.GroupScheduling
{
    ...
    ///
    /// </summary>
    [DisplayName( "Group Scheduler 2.0" )]
    [Category( "Group Scheduling 2.0" )]
...
btnCopyToClipboard.ClientID );
        ...
        protected void AutoSchedule( List<Group> groups )
        {
            ...
            int resourceId = -1;
            GroupSchedulerResourceListSourceType schedulerResourceListSourceType = (GroupSchedulerResourceListSourceType)hfSchedulerResourceListSourceType.ValueAsInt();
            bool isDataView = schedulerResourceListSourceType == GroupSchedulerResourceListSourceType.DataView;
        ...
        protected void UpdateGroupScheduleAssignmentPreference( int attendanceId, int groupMemberId )
        {
            ...
            Rock.Model.AttendanceService attendanceService = new Rock.Model.AttendanceService( rockContext );
