<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberList-Seating.ascx.cs" Inherits="RockWeb.Blocks.Groups.GroupMemberList" %>
                ...
                <div class="panel panel-block">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="grid grid-panel">
                            ...
                            <Rock:Grid ID="gGroupMembers"  ShowFooter="false" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gGroupMembers_Edit" CssClass="js-grid-group-members">
                                <Columns>
