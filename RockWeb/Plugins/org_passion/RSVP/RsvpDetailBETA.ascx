<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RsvpDetailBETA.ascx.cs" Inherits="RockWeb.Blocks.RSVP.RSVPDetail" %>
                ...
                <asp:Panel ID="pnlDetails" runat="server">
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            ...
                            <Rock:RockLiteral ID="lOccurrenceDate" runat="server" Label="Event Date" />
                            <Rock:RockLiteral ID="lOccurrenceClosed" runat="server" Label="RSVP Closed" />
                ...
                <asp:Panel ID="pnlEdit" runat="server">
                    <fieldset id="fieldsetViewSummary" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <Rock:DatePicker ID="dpOccurrenceDate" runat="server" Label="Event Date" Required="true" />
                                <Rock:DateTimePicker ID="dtpOccurrenceClosed" runat="server" Label="RSVP Closed" Required="false" />
                            </div>
                            <div class="col-sm-6">
