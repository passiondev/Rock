...
", "", 2 )]
    ...
    [SystemCommunicationFieldAttribute( "Confirm Account Template", "Confirm Account Email Template", false, Rock.SystemGuid.SystemCommunication.SECURITY_CONFIRM_ACCOUNT, "", 4 )]
...
", "", 5 )]
    ...
    [TextField( "New Account Text", "The text to show on the New Account button.", false, "create account", "", 7, "NewAccountButtonText" )]
    ...
    public partial class Login : Rock.Web.UI.RockBlock
    {
        ...
        private void ApplyBlockSettings()
        {
            ...
            btnNewAccount.Text = this.GetAttributeValue( "NewAccountButtonText" ) ?? "create account";
        ...
        protected void btnHelp_Click( object sender, EventArgs e )
        {
            ...
            if ( !string.IsNullOrWhiteSpace( GetAttributeValue( "HelpPage" ) ) )
            {
                ...
                NavigateToLinkedPage( "HelpPage", parms );
            }
            else
            {
