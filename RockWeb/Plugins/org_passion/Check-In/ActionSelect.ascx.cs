        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            else
            {
                if ( !Page.IsPostBack )
                {
                    ...
                    {
                        if ( UserBackedUp && ( !CurrentCheckInState.CheckInType.AllowCheckoutDefault || !family.CheckOutPeople.Any() ) )
                        {
                            GoBack();
                        }
                        else
                        {
                            if ( !CurrentCheckInState.CheckInType.AllowCheckoutDefault || !family.CheckOutPeople.Any() )
                            {
