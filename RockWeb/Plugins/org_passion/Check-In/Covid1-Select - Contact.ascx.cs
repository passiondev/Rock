...
{
    [DisplayName("Passion | COVID-19-1 Contact")]
    [Category("Check-in")]
    ...
    public partial class COVID48HourSelect : CheckInBlockMultiPerson
    {
        ...
        public override bool RequiresSelection( bool backingUp )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ( person.StateParameters.ContainsKey("CovidContact14") )
                    {
        ...
        private bool NoConfiguredAbilityLevels( List<CheckInGroupType> groupTypes )
        {
            ...
            {
                var groupTypeAttributes = groupType.GroupType.GetAttributeValues("CovidContact14");
                ...
                {
                    var groupAttributes = group.Group.GetAttributeValues("CovidContact14");
        ...
        protected void rSelection_ItemCommand( object source, RepeaterCommandEventArgs e )
        {
            if ( KioskCurrentlyActive )
            {
                ...
                if ( person != null )
                {
                    ...
                    _personAbilityLevelGuid = person.Person.GetAttributeValue("CovidContact14").ToUpper();

                    // Save the fact that user has already selected an ability level so they won't be asked again
                    person.StateParameters.AddOrReplace("CovidContact14", _personAbilityLevelGuid.ToString() );
                    ...
                    if ( _personAbilityLevelGuid != selectedAbilityLevelGuid )
                    {
                        ...
                        using ( var rockContext = new RockContext() )
                        {
                            ...
                            if ( p != null )
                            {
                                ...
                                p.SetAttributeValue("CovidContact14", selectedAbilityLevelGuid.ToUpperInvariant() );
        ...
        protected override void NavigateToPreviousPage( Dictionary<string, string> queryParams, bool validateSelectionRequired )
        {
            if ( CurrentCheckInState.CheckInType.TypeOfCheckin == TypeOfCheckin.Family )
            {
                ...
                {
                    currentPerson.StateParameters.Remove("CovidContact14");
